    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::check() && Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.buildings.index')" :active="request()->routeIs('admin.buildings.index')">
                    {{ __('Корпустар') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.floors.index')" :active="request()->routeIs('admin.floors.index')">
                    {{ __('Этаждар') }}
                </x-responsive-nav-link>
