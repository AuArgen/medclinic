            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <form method="POST" action="{{ route('admin.departments.update', $department->id) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="icon" class="block mt-1 w-full" type="text" name="icon" :value="old('icon', $department->icon)" />
                    ...
                    <div>
                        ...
                        <textarea id="short_description" name="short_description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('short_description', $department->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $department->description) }}</textarea>
                    ...
                    <div>
                        ...
                        @if ($department->image)
                            <img src="{{ asset('storage/' . $department->image) }}" alt="{{ $department->name }}" class="h-20 w-20 object-cover rounded-full mb-2">
                        @endif
