        ...
        return [
            [
                ...
                'content' => [
                    ...
                    'Одделдерди көрүү' => 'Навигациядагы "Одделдер" шилтемесин басып, клиниканын бардык одделдери менен тааныша аласыз. "Көбүрөөк маалымат" шилтемеси аркылуу одделдин толук маалыматын, ага тиешелүү врачтарды көрө аласыз.',
                ],
            ],
            [
            ...
            [
                ...
                'content' => [
                    ...
                    'Одделдерди башкаруу' => '"Башкаруу" -> "Одделдер" бөлүмүнө өтүп, жаңы одделдерди жана под-одделдерди түзүп, алардын маалыматтарын (аталышы, сүрөтү, иконкасы, толук маалыматы) өзгөртө аласыз.',
